...
RC DefaultConditionFilter::init(Table &table, const Condition &condition)
{
  ...
  assert(condition.left_expr->type == 0);
  assert(condition.right_expr->type == 0);
  UnaryExpr *left_expr = condition.left_expr->unaryExpr;
  UnaryExpr *right_expr = condition.right_expr->unaryExpr;
